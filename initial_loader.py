...
class ConfigLoader:
    ...
    # Get the quantiles for forecasting
    def get_quantiles(self, model_type):
        return self.config['forecasting']['algorithms'][model_type].get('quantiles', [])

    # Get the alpha value for forecasting
