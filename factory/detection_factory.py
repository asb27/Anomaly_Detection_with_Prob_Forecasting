from detection_methods.detection_with_quantile import DetectionWithQuantile
from detection_methods.detection_with_threshold import DetectionWithThreshold
...
class DetectionFactory:
    ...
    def get_detection_method(self, method_name, params):
        if method_name == 'detection_with_threshold':
            return DetectionWithThreshold(self.config_loader, params)
        elif method_name == 'detection_with_quantile':
